...
int main(int argc, char *argv[]){
  crack("$6$AS$0NEq0r/zKN/16QaLHTDXdcCwcmLXQGqnaTC4cTiMlgGSJIHb9Iw4WZHloKD5eaEhV3R9102aNx3WV3dM8nCfv0");		//Copy and Paste your ecrypted password here using EncryptShA512 program
  printf("%d solutions explored\n", count);

  return 0;
}
$6$AS$0NEq0r/zKN/16QaLHTDXdcCwcmLXQGqnaTC4cTiMlgGSJIHb9Iw4WZHloKD5eaEhV3R9102aNx3WV3dM8nCfv0
